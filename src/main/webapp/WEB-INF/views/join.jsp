        ...
        <body>
            <div id="fh5co-wrapper">
                <div id="fh5co-page">
                    ...
                    <div class="container-wrapper d-flex justify-content-center align-items-center vh-100">
                        <div class="container p-5 bg-light rounded shadow" style="max-width: 600px;padding: 50px; ">
                            ...
                            <form action="/join" method="post" id="joinForm">
                                ...
                                <button type="submit" class="btn btn-primary w-100" style="width: 100%; max-width: 500px; margin-top: 30px;">Join</button>
